...
module bus_adapter
(
    output [255:0] mem_wdata256, // Cache
    input [255:0] mem_rdata256, // Cache
    input [31:0] mem_wdata, // CPU
    output [31:0] mem_rdata, // CPU
    input [3:0] mem_byte_enable, // CPU
    output logic [31:0] mem_byte_enable256, // Cache
    input [31:0] address // CPU
);
